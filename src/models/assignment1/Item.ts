...
export abstract class Item {
  ...
  getDisplayDetails(): Record<string, string | number> {
    return {
      ...
      "Tax Per Unit": this.calculateTaxPerUnit(),
      "Total Tax": this.calculateTotalTax(),
      "Final Price Per Unit": this.calculateFinalPricePerUnit(),
      "Total Final Price": this.calculateTotalFinalPrice(),
    };
  }
}
